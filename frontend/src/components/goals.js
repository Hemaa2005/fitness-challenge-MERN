...
const Goals = () => {
  ...
  return (
    <div className="bg-goals w-full h-auto p-20 flex flex-col justify-center items-center">
      {step === 1 && (
        <div className="signin-container space-y-4 shadow-lg shadow-gray-700 hover:shadow-xl hover:shadow-slate-700  flex flex-row items-center rounded-md">
      ...
      {step === 2 && (
        <div className="shadow-lg signin-container  shadow-gray-700 hover:shadow-xl hover:shadow-slate-700 flex flex-col items-center ">
          <h1 className="text-xl font-bold text-white">It's time for Goals.</h1>
